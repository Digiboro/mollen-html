...
<head>
  ...
  <title>Категория 2 уровень</title>
</head>
        ...
        <div class="category-content col">
          <div class="category-content-top">
            <div class="category-content-top-inner">
              ...
              <h2 class="category-title h2">Постельное белье</h2>
            </div>
          </div>
          ...
          <ul class="tabs-nav">
            ...
            <li class="tabs-nav-item">
              <button class="tabs-nav-btn" type="button">Простыни</button>
            </li>
            <li class="tabs-nav-item">
              <button class="tabs-nav-btn" type="button">Пододеяльники</button>
            </li>
          </ul>
          ...
          <div class="tabs-content">
            ...
            <div class="tabs-content-item">Таб 2</div>
            <div class="tabs-content-item">Таб 3</div>
          </div>

          <p class="category-complects-title">Готовые комплекты</p>
          <div class="category-complects-list">
            <div class="product hover-effect">
              <div class="product-inner">
                <div class="product-top">
                  <div class="product-top-first">
            ...
            <div class="category-pagination pagination">
              <ul class="pagination-list">
                <li class="pagination-item prev">
                  <a class="pagination-link" href=""><svg width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 1s-.8856 1.2257-1.6667 1.909C2.5523 3.5926 1 4.5 1 4.5s1.5523.9075 2.3333 1.591C4.1143 6.7742 5 8 5 8" stroke="#1E1E1E" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                </li>
                ...
                <li class="pagination-item next">
                  <a class="pagination-link" href=""><svg width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 8s.8856-1.2257 1.6667-1.909C3.4477 5.4074 5 4.5 5 4.5s-1.5523-.9075-2.3333-1.591C1.8857 2.2258 1 1 1 1" stroke="#1E1E1E" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                </li>
              </ul>
            </div>
            <button class="category-more-trigger" type="button"><svg width="23" height="25" viewBox="0 0 23 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.396 8.0703 11.325.9993l-7.071 7.071M11.3269 23.6262l-7.071-7.071m7.071 7.071 7.0711-7.071m-7.0711 7.071V.9988" stroke="#222730"/></svg><span>показать больше</span></button>
