    ...
    <div class="footer-inner">
      <div class="footer-first">
        <div class="footer-logo">
          <img src="img/logo-gray.svg" alt="logo">
        </div>
        
        <p class="footer-copyright text-gray">2021 © Mollen.<br> Все права защищены</p>
      </div>

      <nav class="footer-nav">
        <ul class="footer-nav-list">
          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Постельное белье</a>
          </li>
          
          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Одежда</a>
          </li>

          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Ароматы</a>
          </li>

          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Аксессуары</a>
          </li>
        </ul>
        <ul class="footer-nav-list">
          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Размерный гид</a>
          </li>

          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Доставка и оплата</a>
          </li>

          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Гарантия и возврат</a>
          </li>

          <li class="footer-nav-item">
            <a class="footer-nav-link link-gray" href="">Частые вопросы</a>
          </li>
        </ul>
      </nav>

      <div class="footer-last">
        <a class="footer-tel link-black" href="tel:88002222222">8 800 222 22 22</a>
        
        <a class="footer-callback-trigger" data-mfp-src="#popup-callback-form" href="">Заказать звонок</a>
...
<form id="popup-callback-form" class="popup-callback-form mfp-hide popup-main">
