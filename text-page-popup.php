...
<head>
  ...
  <title>Страница=конструктор (Popup)</title>
</head>
  ...
  <main class="text-page no-top-padding main">
    <div class="container">
      <div class="text-page-inner">
        <div class="text-page-intro black-bg">
          <h1 class="text-page-intro-title h1">новая<br> коллекция</h1>
          <p class="text-page-subtitle">У каждого принта «Моллен» есть своя история,<br> которую мы вам сейчас расскажем.</p>
        </div>
        <br>
        <br>
        <br>
