...
<head>
  ...
  <title>Страница комплекта</title>
</head>
...
<body>
    ...
    <div class="container">
      <div class="complect-page-sliders-content-wrap">
        ...
        <div class="complect-page-content">
          ...
          <div class="complect-page-product-list">
            <div class="complect-page-product product-2">
              <span class="product-2-quantity">2</span>
              <div class="product-2-img">
                <img src="img/complect-page-product.png" alt="img">
              </div>
  ...
  <div id="size-guide" class="size-guide popup-main">
