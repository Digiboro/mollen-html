          ...
          <div class="header-search-result-list">
            <a class="header-search-result-item" href="">
              <div class="header-search-result-img">
                <img src="img/header-search-result.jpg" alt="img">
              </div>

              <div class="header-search-result-info">
                <p class="header-search-result-title">Название товара в две строки</p>
          
                <p class="header-search-result-price">18 000₽</p>
              </div>
            </a>
